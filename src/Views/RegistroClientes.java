...
public class RegistroClientes extends javax.swing.JFrame {
    ...
    private void validateField(JDateChooser jDateChooser) {
        if ("".equals(jDateChooser.getDateFormatString())) {
            if (formStatus.isValid()) formStatus.setValid(false);
    ...
    private boolean saveOrUpdateArticulo() {
        ...
        if (formStatus.isValid()) {             
            ...
            try {
                ...
                updateTable(cliente);
                clearForm();
                JOptionPane.showMessageDialog(null, "Artículo " + (cliente.getId() > 0 ? "modificado" : "agregado") + " con éxito", "Success", JOptionPane.INFORMATION_MESSAGE);
